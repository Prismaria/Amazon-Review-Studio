...
React__default.createElement("div", { className: "p-8 flex flex-col items-center text-center" }, alert2.icon && React__default.createElement("div", { className: "mb-6 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-2xl" }, IconMap[alert2.icon]), React__default.createElement("h3", { className: "text-2xl font-black tracking-tight text-gray-900 dark:text-gray-100 mb-2" }, alert2.title), alert2.text && React__default.createElement("p", { className: "text-gray-600 dark:text-gray-400 leading-relaxed" }, alert2.text), alert2.html && React__default.createElement(
        ...
        "button",
        {
          onClick: () => alert2.resolve({ isConfirmed: false, isDenied: false }),
      ...
      ), alert2.showDenyButton && React__default.createElement(
        "button",
        {
          onClick: () => alert2.resolve({ isConfirmed: false, isDenied: true }),
          ...
          style: { backgroundColor: alert2.denyButtonColor }
        },
        alert2.denyButtonText || "No"
      ), React__default.createElement(
        "button",
        {
          onClick: () => alert2.resolve({ isConfirmed: true, isDenied: false }),
  ...
  const AlertProvider = ({ children }) => {
    ...
    const confirm = React__default.useCallback((options) => showAlert(options, true), [showAlert]);
    return React__default.createElement(AlertContext.Provider, { value: { alert: alert2, confirm } }, children, React__default.createElement(AlertPortal, { alerts }));
  };
  const PASTEBIN_ORIGIN = "https://pastebin.com";
  function toAbsolutePastebinUrl(path) {
    if (path.startsWith("http://") || path.startsWith("https://")) return path;
    return `${PASTEBIN_ORIGIN}${path.startsWith("/") ? path : `/${path}`}`;
  }
  function parsePastebinProfileFromHtml(html) {
  ...
  function normalizePhrasesFromLocal(phrases) {
    return phrases.map((p) => ({
      label: p.label || "",
      text: p.content
    })).sort((a, b) => a.text.localeCompare(b.text));
  }
  function parseCloudTemplatesFromPaste(content) {
    try {
      ...
      })).filter((t) => t.name && t.text).sort((a, b) => a.name.localeCompare(b.name));
    } catch {
      return [];
    }
  }
  function parseCloudPhrasesFromPaste(content) {
    try {
      const data = JSON.parse(content);
  ...
  function applyPhrasesImport(local, cloud, mode, generateId) {
    let result = mode === "replace" ? [] : [...local];
    let importedCount = 0;
  ...
  function parsePastesFromListXml(xmlResponse) {
  ...
  function usePastebin() {
    ...
    const { alert: alert2, confirm } = useAlert();
    ...
    const fetchHtml = React__default.useCallback(async (url) => {
      if (typeof GM_xmlhttpRequest !== "undefined") {
        return new Promise((resolve, reject) => {
          GM_xmlhttpRequest({
            ...
            url,
            onload: (response2) => {
              if (response2.status >= 200 && response2.status < 300) resolve(response2.responseText);
              else reject(new Error(response2.responseText || `HTTP ${response2.status}`));
            },
    ...
    const applyPastebinProfile = React__default.useCallback((profile) => {
    ...
    const fetchPastebinProfile = React__default.useCallback(async () => {
    ...
    const syncTemplatesFromCloud = React__default.useCallback(async () => {
      ...
      try {
        ...
        let cloudTemplates = modernT ? parseCloudTemplatesFromPaste(await getPasteContent(modernT.key)) : [];
        let cloudPhrases = phrasePaste ? parseCloudPhrasesFromPaste(await getPasteContent(phrasePaste.key)) : [];
        ...
        if (modernT && !cloudTemplatesEmpty && !templatesEqual) {
          ...
          const mode = localTemplatesEmpty ? "replace" : importMode;
        ...
        if (phrasePaste && !cloudPhrasesEmpty && !phrasesEqual) {
          ...
          const mode = localPhrasesEmpty ? "replace" : importMode;
...
React__default.createElement("option", { value: "gemini-3-flash-preview" }, "Gemini 3 Flash Preview")
      ...
      ), React__default.createElement("div", { className: "w-10 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-indigo-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-indigo-600" }))), React__default.createElement("p", { className: "text-[10px] font-bold italic uppercase text-amber-800 tracking-wide leading-relaxed mt-2 pt-3 border-t border-amber-100" }, "These settings enable real-time cloud sync, just like OneDrive. Any deletions must be fully intentional — they will be reflected in the cloud as well."))), React__default.createElement("div", { id: "ars-pastebin-creds-group", className: "ars-setting-group border border-gray-100 bg-gray-50/30 p-4 rounded-xl space-y-4" }, React__default.createElement("div", { className: "flex items-center gap-2 mb-1" }, React__default.createElement(Key, { size: 16, className: "text-orange-500" }), React__default.createElement("span", { className: "text-sm font-semibold text-gray-700" }, "Pastebin Credentials")), React__default.createElement(
        Input,
        {
          label: "API Dev Key",
...
React__default.createElement("option", { value: "fast" }, "Fast")
  ...
  const EditorToolbar = ({
    ...
    const pastebinProfileUrl = settings.amazon_pastebin_profile_url || (settings.amazon_pastebin_profile_username ? `https://pastebin.com/u/${encodeURIComponent(settings.amazon_pastebin_profile_username)}` : "");
    ...
    }, [showCloudPopover, getSyncQuota2, settings.amazon_pastebin_api_user_key, fetchPastebinProfile]);
    React__default.useEffect(() => {
...
React.createElement(Cloud, { size: 16 })
    ), showCloudPopover && React.createElement("div", { ref: cloudPopoverRef, className: "ars-phrase-popover", style: { width: "220px" } }, React.createElement(
      "div",
      {
...
React.createElement("div", { style: { flex: 1, minWidth: 0 } }, React.createElement("h3", { style: { margin: 0, fontSize: "1rem", display: "flex", alignItems: "center", gap: "0.5rem", fontWeight: 600 } }, React.createElement(Cloud, { size: 16 }), " Cloud Sync"), quota && React.createElement("div", { style: {
        fontSize: "0.7rem",
        fontWeight: 600,
      ...
      pastebinAvatarUrl && pastebinProfileUrl && React.createElement(
        "a",
        {
...
React.createElement(
    ...
    ), React.createElement("div", { className: "ars-popover-content" }, !settings.amazon_pastebin_api_user_key ? React.createElement("div", { className: "p-3 text-sm text-gray-500 text-center" }, React.createElement("p", { className: "mb-2" }, "Setup API to sync data"), React.createElement(Button, { variant: "primary", size: "sm", onClick: () => {
      setSettingsTab("sync");
...
async testConnection() {
  ...
  function loadSaveInstructionOnEnter() {
    try {
  ...
  const AIModal = ({ isOpen, onClose, onInsert, productTitle = "", asin, starRating, existingReviewText = "" }) => {
    ...
    const [instructionPresets, setInstructionPresets] = React__default.useState(() => loadInstructionPresets());
    const [saveInstructionOnEnter, setSaveInstructionOnEnter] = React__default.useState(() => loadSaveInstructionOnEnter());
    const [additionalInstructionsInputUnlocked, setAdditionalInstructionsInputUnlocked] = React__default.useState(false);
...
${currentThoughts}`;
    ...
    const presetSelectValue = React__default.useMemo(() => {
    ...
    const handleAdditionalInstructionKeyDown = (e) => {
    ...
    const handleSaveOnEnterToggle = (checked) => {
...
React__default.createElement("option", { value: "local" }, "Local LLM (LM Studio/Ollama)")
      ...
      ), !useExistingReview && React__default.createElement("div", { className: `absolute bottom-2 right-3 text-[10px] font-bold px-1.5 py-0.5 rounded ${userThoughts.length >= MIN_CHARS ? "text-green-600 bg-green-50" : "text-gray-400 bg-gray-50"}` }, userThoughts.length, " / ", MIN_CHARS), useExistingReview && React__default.createElement("div", { className: "absolute bottom-2 right-3 text-[10px] font-bold px-1.5 py-0.5 rounded text-blue-600 bg-blue-50" }, "Existing Text Used (", existingReviewText.length, " chars)")), React__default.createElement("div", { className: "ars-ai-additional-block" }, React__default.createElement("div", { className: "ars-ai-additional-head" }, React__default.createElement("label", { className: "ars-label text-xs text-gray-500 font-medium" }, "Additional Instructions ", React__default.createElement("span", { className: "text-[10px] text-gray-400 font-normal ml-1" }, "(Optional)")), React__default.createElement("label", { className: "ars-ai-additional-save-enter" }, React__default.createElement(
        "input",
        {
          type: "checkbox",
      ...
      ), "Save on Enter")), React__default.createElement(
        "form",
        {
...
React__default.createElement("div", { className: "ars-ai-additional-presets-row" }, React__default.createElement(
          "select",
          {
...
React__default.createElement("option", { value: "" }, "Saved instructions…"),
          instructionPresets.map((text, i) => React__default.createElement("option", { key: `${i}-${text.slice(0, 24)}`, value: String(i), title: text }, text.length > 72 ? `${text.slice(0, 72)}…` : text))
        ), presetSelectValue !== "" && React__default.createElement(
          "button",
          {
            type: "button",
...
React__default.createElement(Trash2, { size: 13, strokeWidth: 2, "aria-hidden": true })
        ))

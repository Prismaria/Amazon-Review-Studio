...
React__default.createElement("option", { value: "fast" }, "Fast")
  ...
  const EditorToolbar = ({
    ...
    const getProductInfo = () => {
      ...
      const titleEl = document.getElementById("productTitle") || document.querySelector(".product-title-word-break") || document.querySelector("h1");
